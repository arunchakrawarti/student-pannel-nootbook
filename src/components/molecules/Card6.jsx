...
const Card6 = ({ 
  ...
  return (
    ...
    <div className={`p-8 rounded-xl shadow-lg border border-gray-200 ${cardBgColor}`}>
      ...
      <button className='w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-[#FF6029] text-white font-medium text-[16px] hover:bg-orange-600 transition-colors'>
